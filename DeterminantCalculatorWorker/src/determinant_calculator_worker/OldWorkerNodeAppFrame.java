...
public class OldWorkerNodeAppFrame extends JFrame implements ActionListener {
	...
	public OldWorkerNodeAppFrame() {
		...
		workersText = new JTextArea("Workers list: no worker");
